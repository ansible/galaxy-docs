...
.. |atversion| replace:: Ansible Tower Version 2.4.3
.. |atversionshort| replace:: Ansible Tower 2.4.3
.. |pubdate| replace:: January 27, 2016
...
#for docname in ('userguide', 'installandreference', 'quickstart', 'quickinstall', 'towerapi', 'administration'):
